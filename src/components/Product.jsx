...
import css from "./Product.module.css"
  ...
  export const Product = ({id, titel, price, discount, hendelDeleteProduct }) =>{
    const productBg = 
      discount ? '#73b86e'  :'#f5834f'
    ...
    <div className={css.product} style={productStyles}> 
      ...
      <img
       ...
       {discount && <h3>Discount:{discount}%</h3>}
        ...
        <p>Price:{price}</p>
        <button type="button" className={css.buttonAddToCard} >Add to cart</button>
        <button  onClick={()=> hendelDeleteProduct(id)} type="button" className={css.buttonDeleteProduct} >
        &#10060; 
        </button>
      </div>
      )
